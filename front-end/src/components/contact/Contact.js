...
const Contact = () => {
  ...
  const socials = {
    LinkedIn: {
      ...
      link: "https://www.linkedin.com/in/jacobhickman12/",
    },
    GitHub: {
      svg: (
        <svg
      ...
      link: "https://github.com/elusionz243",
    },
    Gmail: {
      svg: (
        <svg
      ...
      link: "jacobhickman243@gmail.com",
    },
  };
  ...
  const copyEmail = (e) => {
    ...
    const code = document.getElementById("email-link");
    code.innerText = "Copied email to clipboard!";
    const interval = setInterval(() => {
      code.innerText = socials["Gmail"].link;
    ...
    <div>
      <div className="contact-container">
        ...
        <div className="socials">
          {Object.keys(socials).map((social, index) => (
            <a
              key={index}
              id={social}
              href={social === "Gmail" ? "" : socials[social].link}
            ...
            >
              {socials[social].svg}
              {social === "Gmail" ? (
                <code id="email-link">{`${socials[social].link}`}</code>
              ) : (
                social
              )}
            </a>
        ...
        {formStatus === 200 ? (
          ...
          <Alert
            message={
              "Sorry, something went wrong. Please try again later or contact me through another method."
            }
            formStatus={formStatus}
            setFormStatus={setFormStatus}
          />
